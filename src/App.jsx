...
export default function App() {
  ...
  <div className="px-2 absolute bottom-20 text-white md:text-black">
      ...
      <select className="text-black" name="CHANGE LANGUAGE" id="">
      <option name="CHANGE LANGUAGE" value="English">English</option>
      <option name="CHANGE LANGUAGE" value="English">English</option></select>
  ...
  <div className="md:px-4 w-full mt-2 md:w-3/5 md:flex">
    ...
    <div className="ml-2">
      ...
      <Input width="80%" className=" " label="Enter Tracking Id" />
      
    </div>

      <Button hideIn="xs" size={"md"} className="ml-2 mt-2 bg-blue-400  md:mt-10 md:ml-2 text-white">Track</Button>
...
<Button size="md" className="bg-white mb-3 text-black mt-3" >Learn More ...</Button>
