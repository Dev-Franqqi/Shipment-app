    ...
    <>
      <header className="bg-gradient-to-br from-blue-950 to-black text-white text-center py-12 ">
        ...
        <p className="font-semibold">
          {" "}
          <span className="text-gray-400">Home/ </span> Services / Railway
        </p>
      </header>
        ...
        <div className="md:flex">
          <div>
            <p className="md:text-lg text-gray-500">
              Addy Prime Logistics has a flexible, reliable and efficient
              overland transportation offering, including Road, Rail and
              Intermodal Services. We have a global capability with services
              operating in Europe, North Africa, Middle East, Asia Pacific and
              Americas.
            </p>
          </div>
