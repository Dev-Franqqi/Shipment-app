...
<main className="px-3 py-10 text-gray-500 md:flex">
  ...
  <h2 className="text-blue-950 text-2xl font-semibold mb-5 md:text-4xl">Our Vision</h2>
  ...
  <img className="border-8 border-white rounded-md mb-10 md:w-2/5 md:rounded-md md:border-8" src={Wareh} alt="" />
</main>
