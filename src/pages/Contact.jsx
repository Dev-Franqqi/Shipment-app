    ...
    <>
      ...
      <main className="text-gray-500 mb-3 px-3 mt-5">
        ...
        <div className="md:flex md:space-x-10">
          <img
            className="mt-3 mb-4 border-8 border-white rounded-md w-2/5"
            src={Office}
            alt=""
          />
          <div>
            <div className="w-3/5 mt-5">
              <h4 className="font-semibold text-blue-950 text-xl">
                Office Address
              </h4>
              <p>
                North West Midlands Mail Center, Sun Street, Wolverhampton, WV1
                1AA
              </p>

              <p>
                <a href="mailto:info@asapprimelogistics">
                  info@asapprimelogistics
                </a>
              </p>
            ...
            <div className="mb-5 mt-5 w-3/5">
              ...
              <p>Mon -Thu: 8:30AM - 6:00pm</p>
              <p>Fri: 9:00AM - 5:30PM</p>
            ...
            <div>
              <div>
                ...
                <p>
                  EMAIL US:
                  <span className="text-sky-500"> info@asapprimelogistics</span>
                </p>
              </div>
            </div>
          </div>
